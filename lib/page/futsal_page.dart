...
class FutsalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var futsalProvider = Provider.of<FutsalProvider>(context);
    futsalProvider.getRecommendedFutsal();
          ...
          child: ListView(
            children: [
              ...
              Padding(
                ...
                FutureBuilder(
                  future: futsalProvider.getRecommendedFutsal(),
                  builder: (context, snapshot) {
                    if(snapshot.hasData){

                      List<Futsal> data = snapshot.data;
