...
class DetailBadmintonPage extends StatelessWidget {

  final Badminton badminton;

  DetailBadmintonPage(this.badminton);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: badminton.photos.map((item) {
                            return Container(
