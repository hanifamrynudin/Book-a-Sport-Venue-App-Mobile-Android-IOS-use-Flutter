...
import 'package:google_signin_example/page/detail_futsal_page.dart';
    ...
    return InkWell(
      onTap: (){
        Navigator.push(
            context, 
            MaterialPageRoute(
              builder: (context)=>DetailFutsalPage(futsal),
            ),
          );
        },
